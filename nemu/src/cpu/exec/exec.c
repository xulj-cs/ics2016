...
/* 0x80 */
make_group(group1_b,
	add_i2rm_b, or_i2rm_b, adc_i2rm_b, adc_i2rm_b, 
...
make_group(group1_sx_v,
	add_si2rm_v, or_si2rm_v, adc_si2rm_v, adc_si2rm_v, 
...
/* 0xc0 */	group2_i_b, group2_i_v, ret_near_i_v, ret_near_v,
